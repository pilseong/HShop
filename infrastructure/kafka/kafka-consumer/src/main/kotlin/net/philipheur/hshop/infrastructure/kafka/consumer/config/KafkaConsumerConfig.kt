package net.philipheur.hshop.infrastructure.kafka.consumer.config

import net.philipheur.hshop.infrastructure.kafka.configdata.KafkaConfigData
import net.philipheur.hshop.infrastructure.kafka.configdata.KafkaConsumerConfigData
