...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4703033362638704947L;
  ...
  private net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentOrderStatus paymentOrderStatus;
   ...
   */
  public PaymentRequestAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentOrderStatus paymentOrderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: paymentOrderStatus = (net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentOrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentOrderStatus getPaymentOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentOrderStatus(net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentOrderStatus value) {
   ...
   */
  public static net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder newBuilder() {
    return new net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder();
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder newBuilder(net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder other) {
    if (other == null) {
      return new net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder();
    } else {
      return new net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder newBuilder(net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel other) {
    if (other == null) {
      return new net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder();
    } else {
      return new net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder setPaymentOrderStatus(net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentRequestAvroModel.Builder clearPaymentOrderStatus() {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.paymentOrderStatus = fieldSetFlags()[6] ? this.paymentOrderStatus : (net.philipheur.hshop.infrastructure.kafka.model.avro.PaymentOrderStatus) defaultValue(fields()[6]);
        return record;
