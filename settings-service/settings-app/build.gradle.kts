...
dependencies {
    ...
    implementation(project(":settings-controller"))
    implementation(project(":settings-dataaccess"))
...
application {
    ...
    mainClass.set("net.philipheur.hshop.settingsservice.SettingsServiceApplicationKt")
}

tasks.named<BootBuildImage>("bootBuildImage") {
    imageName.set("${project.group}/settings-service:${project.version}")
}
