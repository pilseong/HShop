...
dependencies {
    ...
    implementation(project(":user-controller"))
    implementation(project(":user-dataaccess"))
    implementation(project(":user-domain-service"))
    implementation(project(":user-domain-core"))
...
application {
    ...
    mainClass.set("net.philipheur.hshop.userservice.UserServiceApplicationKt")
}

tasks.named<BootBuildImage>("bootBuildImage") {
    imageName.set("${project.group}/user-service:${project.version}")
}
